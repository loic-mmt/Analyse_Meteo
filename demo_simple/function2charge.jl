...
"""
function trends_climate(means::Vector{Float64}; trend = false, cutting=Nothing, window=Nothing, title ="Climate Trends Analysis")
...
"""
function glm_visu_trend(slope_map::AbstractArray{Float64, 2}, p_map::AbstractArray{Float64, 2}; p_value=0.05, weights_file=nothing, title="Significant Warming Trends, p-value= $p_value")
...
"""
function animate_climatology(data_3d::AbstractArray{<:Union{Missing, Float64}, 3}, weights_file; filename="temperature_evolution.gif", title = "Carte des températures à l'indice $i")
