...
matrix3 = compute_general_climatology(data_folder_basic, weight_prop_basic, 1950, mode=:hourly, selected_months=02)
...
matrix5 = compute_general_climatology(data_folder_basic, weight_prop_basic, 1950, mode=:hourly, selected_months=02)
...
matrix6 = compute_general_climatology(data_folder_basic, weight_prop_basic, 1950, mode=:hourly, selected_months=02)
