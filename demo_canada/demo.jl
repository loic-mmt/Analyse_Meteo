...
# Chaque bloc calcule une climatologie puis genere un ou plusieurs graphs
# sauvegardes dans demo/plot.

# Exemple 1 : information sur une heure precise (03/10/1997 a 19h).
matrix1 = compute_general_climatology(data_folder_ca_31, weight_canada_31, 1950; selected_days=03, selected_months=02, selected_hours=19)
# p1 = carte instantanee de temperature pour cette date/heure.
p1 = vizumap(matrix1, weight_canada_31)
...
means_vector_calculation(matrix1, weight_canada_31)


# Exemple 2 : carte moyenne 2020.
# Ici chaque pixel est moyenne sur toutes les dates/heures disponibles en 2020 (mode=:total).
matrix2 = compute_general_climatology(data_folder_ca_31, weight_canada_31, 1950, mode=:total, selected_months=02)
# p2 = carte des moyennes temporelles par pixel en 2020.
p2 = vizumap(matrix2, weight_canada_31)
save_plot(p2, joinpath(plot_dir, "ex2_vizumap.png"))
means_vector_calculation(matrix2, weight_canada_31)

# Exemple 3 : cartes horaires 2012.
matrix3 = compute_general_climatology(data_folder_ca_31, weight_canada_31, 1950, mode=:hourly, selected_months=02)
vector3 = means_vector_calculation(matrix3, weight_canada_31)
...
animate_climatology(matrix3, weight_canada_31, filename=plot_file3)

# Exemple 4 : tendances annuelles (1950->2025) sur la 2e quinzaine de janvier (jours 15 a 31).
matrix4 = compute_general_climatology(data_folder_ca_31, weight_canada_31, 1950; mode=:hourly, selected_months=02, selected_days=02:20)
vector4 = means_vector_calculation(matrix4, weight_canada_31)
...
slope4, pvalue4 = calculate_trends_glm(matrix4, weight_canada_31)
# p4_glm_005 = carte des pentes de tendance significatives au seuil p <= 0.05.
p4_glm_005 = glm_visu_trend(slope4, pvalue4; weights_file=weight_canada_31)
save_plot(p4_glm_005, joinpath(plot_dir, "ex4_glm_p005.png"))
# p4_glm_015 = meme carte avec seuil p <= 0.15.
p4_glm_015 = glm_visu_trend(slope4, pvalue4; p_value=0.15, weights_file=weight_canada_31)
save_plot(p4_glm_015, joinpath(plot_dir, "ex4_glm_p015.png"))


# Exemple 5 : tendance mensuelle (1950->2025).
matrix5 = compute_general_climatology(data_folder_ca_31, weight_canada_31, 1950, mode=:hourly, selected_months=02)
vector5 = means_vector_calculation(matrix5, weight_canada_31)
...
matrix6 = compute_general_climatology(data_folder_ca_31, weight_canada_31, 1950, mode=:yearly, selected_months=02)
vector6 = means_vector_calculation(matrix6, weight_canada_31)
