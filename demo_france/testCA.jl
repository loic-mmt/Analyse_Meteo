...
animate_climatology(matrix3, weight_canada_31)

# Exemple 4 : tendances annuelles (1950->2025) sur la 2e quinzaine de janvier (jours 15 a 31).
matrix4 = compute_general_climatology(data_folder_ca_31, weight_canada_31, 1950:2025; mode=:yearly, selected_months=01, selected_days=15:31)
...
matrix5 = compute_general_climatology(data_folder_ca_31, weight_canada_31, 1950:2025, mode=:monthly)
...
matrix6 = compute_general_climatology(data_folder_ca_31, weight_canada_31, 1950:2025, mode=:yearly)
